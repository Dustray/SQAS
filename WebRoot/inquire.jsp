...
$(function() {
	...
	<body>
		...
		%>
		<div style=" margin-left: 100px;margin-top: 13px;color: #a4ffff;font-size: 17px">
			<a
				href="InquireServlet?limit=4&nowPage=<%=Integer
								.parseInt(request.getParameter("nowPage")) - 1%>">上一页</a>
			<a
				href="InquireServlet?limit=4&nowPage=<%=Integer
								.parseInt(request.getParameter("nowPage")) + 1%>">下一页</a>
		</div>
		<%
			}
		%>
